...
export default class LandingPage extends Component {
  ...
  render() {
    ...
    let style = {
      ...
      emailIcon: {
        width: '50px', height: '50px', color: '#fff', marginRight: '10px'
      },
    ...
    return (
      <MuiThemeProvider>
        <div>
          ...
          <Footer>
            <Wrapper>
              <Contact><a style={style.link} href="mailto:wizardamigos.codecamp@gmail.com"><EmailIcon
                style={ style.emailIcon } />wizardamigos.codecamp@gmail.com</a></Contact>
              <Contact><a style={style.link} target="_blank"
                          href="https://www.facebook.com/groups/369246343421803/"><FaceBookIcon
                style={ style.facebookIcon } />WizardAmigos Codecamp on Facebook</a></Contact>
              <FooterIntro> WizardAmigos is a FREE open source, open collaborative, and free DIY programming school from
                Berlin, now
                starting in Taipei. People of all skill levels and backgrounds are welcome to join and learn
                together.</FooterIntro>
            </Wrapper>
          </Footer>
        </div>
      </MuiThemeProvider>
